...
async function startServer() {
  ...
  app.get("/api/tenant-info", async (req, res) => {
    ...
    try {
      ...
      // 1.5 Auto-create profile for Super Admins if missing
      if (isSuperAdmin && !profileRes.data) {
        const SHARED_TENANT_ID = '6588b6c9-ce84-4140-a69a-f487a0c61dab'; // ID do Lucas (Main Admin)
        console.log(`[SERVER] Auto-criando perfil para Super Admin: ${email}`);
