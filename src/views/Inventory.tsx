        ...
        {isAddItemModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-end justify-center sm:items-center sm:p-4">
            ...
            <motion.div 
              ...
              className="relative z-10 flex w-full max-h-[92dvh] flex-col overflow-hidden rounded-t-3xl border border-white/10 bg-[#1F1F1F] shadow-2xl sm:max-w-lg sm:rounded-3xl"
            >
